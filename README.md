...
* **개발 환경**
  ...
  * Unity 6.0 (6000.0.60f1), C#, Firebase, Git, Notion, Discord
...
* 스테이지 입장 전 캐릭터 배치
* 캐릭터에 따라 범위 패시브 버프, 시너지 버프 효과 적용
...
* 튜토리얼 및 스토리 던전 대사 사운드(AI 사운드 사용)
* UI 효과음
* 숙소 애니메이션 연출
...
* 최초 실행 시 리소스 다운로드가 완료된 이후 로딩 시간이 약 10초정도 소요될 수 있습니다
